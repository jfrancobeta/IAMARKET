    ...
    public UsuarioDTO(Usuario usuario) {
        ...
        if (usuario.getUserType() != null) {
            if (usuario.getUserType() == 0 && usuario.getPerfilCompania() != null) {
                // Es una compañía
                this.perfilCompania = new PerfilCompaniaDTO(usuario.getPerfilCompania());
            } else if (usuario.getUserType() == 1 && usuario.getPerfilDesarrollador() != null) {
                // Es un desarrollador
                this.perfilDesarrollador = new PerfilDesarrolladorDTO(usuario.getPerfilDesarrollador());
            }
        }
    }

...
public class ProyectoDTO {
    ...
    private List<CancelRequestDTO> cancelRequests;

    public ProyectoDTO() {
    }

    public List<CancelRequestDTO> getCancelRequests() {
        return cancelRequests;
    }

    public void setCancelRequests(List<CancelRequestDTO> cancelRequests) {
